...
using EFC.Samples.WPhone.Resources;
...
namespace EFC.Samples.WPhone
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            navigationService = UnityManager.Container.Resolve<INavigationService>();
            AddViewModelRoutings();
            //RootFrame.Navigate(new Uri("/Views/MainPage.xaml"));
