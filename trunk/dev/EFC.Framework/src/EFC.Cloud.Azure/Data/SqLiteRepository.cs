// ----------------------------------------------------------------------------
// <copyright company="EFC" file ="SqLiteRepository.cs">
// All rights reserved Copyright 2015  Enterprise Foundation Classes
// 
// </copyright>
//  <summary>
//  The <see cref="SqLiteRepository.cs"/> file.
//  </summary>
//  ---------------------------------------------------------------------------------------------
namespace EFC.Cloud.Azure.Data
{
    ...
    public class SqLiteRepository<TEntity, TIdentifier> : RepositoryBase<TEntity, TIdentifier> where TEntity : class, IEntity<TIdentifier>
    {
        ...
        {
            return this.DbContext.GetSyncTable<TEntity>().ToEnumerableAsync();
        }
        ...
        {
            return this.DbContext.GetTable<TEntity>().ToEnumerableAsync();
        }
        ...
        {
            return this.DbContext.GetTable<TEntity>().Where(specification.Predicate).ToEnumerableAsync();
        }
        ...
        {
            return this.DbContext.GetSyncTable<TEntity>().Where(specification.Predicate).ToEnumerableAsync();
        }
        ...
        {
            var result = await this.DbContext.GetSyncTable<TEntity>().ToEnumerableAsync();
        ...
        {
            var result = await this.DbContext.GetTable<TEntity>().ToEnumerableAsync();
        ...
        {
            return this.DbContext.GetSyncTable<TEntity>().InsertAsync(entity);
        }
        ...
        {
            return this.DbContext.GetTable<TEntity>().InsertAsync(entity);
        }
        ...
        {
            return this.DbContext.GetTable<TEntity>().UpdateAsync(entity);
        }
        ...
        {
            return this.DbContext.GetSyncTable<TEntity>().UpdateAsync(entity);
        }
        ...
        {
            return this.DbContext.GetTable<TEntity>().DeleteAsync(entity);
        }
        ...
        {
            return this.DbContext.GetSyncTable<TEntity>().PullAsync(queryId, this.DbContext.GetSyncTable<TEntity>().CreateQuery());
        }
        ...
        {
            return this.DbContext.GetSyncTable<TEntity>().PullAsync(queryId, this.DbContext.GetSyncTable<TEntity>().Where(specification.Predicate));
        }
    }
}
